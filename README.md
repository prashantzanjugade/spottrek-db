...
```
cd existing_repo
git remote add origin https://gitlab.barcindia.in/BARCIndia/spot-trek/spottrek-db.git
git branch -M master
...
- [ ] [Set up project integrations](http://gitlab.barcindia.net/BARCIndia/spot-trek/spottrek-db/-/settings/integrations)
...
>>>>>>> b42a23d30e91030c36789a1526e477e7a61567f4
